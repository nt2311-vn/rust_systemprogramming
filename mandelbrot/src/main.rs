...
///  The `upper_left` and `lower right` parameters are points on the complex
...
///
/// The `bounds` argument give thheh height and width of the buffer `pixels`,
/// which holds one grayscale pixel per byte. The `upper_left` and `lower_right`
/// arguments specify points on thhe complex plane corresponding the upper_left
/// and lower_right corner of the pixel buffer.
fn render(
    pixels: &mut [u8],
    bounds: (usize, usize),
    upper_left: Complex<f64>,
